                                ...
                                <tbody>
                                        ...
                                        <td>
                                            <div class="d-flex align-items-center">
                                                <div class="symbol symbol-45px me-5">
                                                    <img src="{{asset('frontend/assets/media/avatars/300-14.jpg')}}"
                                                        alt="">
                                                </div>
                                        ...
                                        <td class="text-end">
                                            <div class="d-flex flex-column w-100 me-2">
                                                <div class="d-flex flex-stack mb-2">
                                                    <span class="text-muted fs-7 fw-bold me-2">50%</span>
                                                </div>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="d-flex align-items-center">
                                                <div class="symbol symbol-45px me-5">
                                                    <img src="{{asset('frontend/assets/media/avatars/300-2.jpg')}}"
                                                        alt="">
                                                </div>
                                                <div class="d-flex justify-content-start flex-column">
                                                    <a href="#"
                                        ...
                                        <td class="text-end">
                                            <div class="d-flex flex-column w-100 me-2">
                                                <div class="d-flex flex-stack mb-2">
                                                    <span class="text-muted fs-7 fw-bold me-2">70%</span>
                                                </div>
                                                <div class="progress h-6px w-100">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="d-flex align-items-center">
                                                <div class="symbol symbol-45px me-5">
                                                    <img src="{{asset('frontend/assets/media/avatars/300-5.jpg')}}"
                                                        alt="">
                                                </div>
                                                <div class="d-flex justify-content-start flex-column">
                                                    <a href="#"
                                        ...
                                        <td class="text-end">
                                            <div class="d-flex flex-column w-100 me-2">
                                                <div class="d-flex flex-stack mb-2">
                                                    <span class="text-muted fs-7 fw-bold me-2">60%</span>
                                                </div>
                                                <div class="progress h-6px w-100">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="d-flex align-items-center">
                                                <div class="symbol symbol-45px me-5">
                                                    <img src="{{asset('frontend/assets/media/avatars/300-20.jpg')}}"
                                                        alt="">
                                                </div>
                                                <div class="d-flex justify-content-start flex-column">
                                                    <a href="#"
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="d-flex align-items-center">
                                                <div class="symbol symbol-45px me-5">
                                                    <img src="{{asset('frontend/assets/media/avatars/300-23.jpg')}}"
                                                        alt="">
                                                </div>
                                                <div class="d-flex justify-content-start flex-column">
                                                    <a href="#"
                                        ...
                                        <td class="text-end">
                                            <div class="d-flex flex-column w-100 me-2">
                                                <div class="d-flex flex-stack mb-2">
                                                    <span class="text-muted fs-7 fw-bold me-2">90%</span>
                                                </div>
                                                <div class="progress h-6px w-100">
