                        ...
                        <div class="card-body pt-3" style="user-select: auto;">
                            ...
                            <div class="modal-body">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-6">
                                        <x-cento-dash-input type="text" name="brand_title" label="Brand Title"
                                            placeholder="Brand Title" :message="$errors->first('brand_title')" />
                                    </div>
                                    <div class="col-6">
                                    ...
                                    <div class="col-6">
                                        <x-textarea type='text' name="brand_info" label="Brand Information"
                                            class="col-12" placeholder="Enter Description"
                                            :message="$errors->first('brand_info')" />
                                    </div>
                                </div>
                            </div>
                            <div class="modal-footer mt-5 gap-2">
                                <x-cento-dash-input type="submit" label="Add brand" />
                                <a class="btn btn-danger" href={{ route('brand.index') }}> Cancel </a>
                            </div>
                            <!--end::Table container-->
                        </div>
                        <!--begin::Body-->
