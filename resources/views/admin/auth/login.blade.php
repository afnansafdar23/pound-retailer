...
<div class="d-flex flex-column flex-root" id="kt_app_root">
    ...
    <div class="d-flex flex-column flex-lg-row flex-column-fluid">
        <!--begin::Logo-->
        <a href="{{route('admin.dashboard')}}" class="d-block d-lg-none mx-auto py-20">
            <img alt="Logo" src="{{asset('assets/media/logos/site_logo.jpg')}}" class="theme-light-show h-25px" />
            <img alt="Logo" src="{{asset('assets/media/logos/site_logo.jpg')}}" class="theme-dark-show h-25px" />
        </a>
        <!--end::Logo-->
        <!--begin::Aside-->
