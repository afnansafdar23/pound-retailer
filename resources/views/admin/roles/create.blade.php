                    ...
                    <div class="card mb-5 mb-xl-8" style="user-select: auto;">
                        ...
                        <div class="card-header border-0 pt-5" style="user-select: auto;">
                            <h3 class="card-title align-items-start flex-column" style="user-select: auto;">
                                <span class="card-label fw-bold fs-3 mb-1" style="user-select: auto;">Add Role</span>
                            </h3>
                        </div>
                        <!--end::Header-->
                        <!--begin::Body-->
                        <div class="card-body pt-3" style="user-select: auto;">
                            ...
                            <div class="modal-body">
                                ...
                                <div class="row">
                                    <div class="col-6">
                                        <x-cento-dash-input type="text" name="name" label="Role Name"
                                            placeholder="Role Name" :message="$errors->first('name')" />
                                    </div>
                                    <div class="col-6">
                                        <x-cento-dash-input type="text" name="guard_name" label="Guard Name"
                                            placeholder="Guard Name" value="web"
                                            :message="$errors->first('guard_name')" />
                                    </div>
                                    @foreach ($permissions as $permission)
                                    <x-cento-dash-input type="checkbox" name="permission_checkbox[]"
                                        :label="$permission['name']" :value="$permission['id']"
                                        :message="$errors->first('permission_checkbox')" />
                                    @endforeach
                                </div>
                            </div>
                            <div class="modal-footer mt-5 gap-2">
                                <x-cento-dash-input type="submit" label="Add Role" />
