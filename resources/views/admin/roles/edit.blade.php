                            ...
                            <div class="modal-body">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-6 fv-row fv-plugins-icon-container">
                                        ...
                                        <input type="text" value="{{ $role['guard_name'] }}" name="guard_name"
                                            placeholder="{{ $role['guard_name'] }}"
                                            class="form-control form-control-lg form-control-solid mb-3 mb-lg-0">
                                        <div class="fv-plugins-message-container invalid-feedback"></div>
                                        @error('guard_name')
                                        <div class="error text-danger">{{ $message }}</div>
                                    ...
                                    <div class="col-xl-3 my-4">
                                        <label class="form-check form-switch form-check-custom form-check-solid">
                                            <input @if ($role_permissions->contains($permission->id))
                                            <?php echo"checked" ?>@endif class="form-check-input" type="checkbox"
                                            name="permission_checkbox[]" value="{{ $permission['id'] }}"/>
                                            <span class="form-check-label fw-semibold text-muted">{{ $permission['name']
                                                }}</span>
                                        </label>
                                    </div>
