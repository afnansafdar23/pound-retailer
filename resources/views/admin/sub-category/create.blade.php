                    ...
                    <div class="card mb-xl-8 mb-5" style="user-select: auto;">
                        ...
                        <div class="card-header border-0 pt-5" style="user-select: auto;">
                            <h3 class="card-title align-items-start flex-column" style="user-select: auto;">
                                <span class="card-label fw-bold fs-3 mb-1" style="user-select: auto;">Add Sub
                                    Category</span>
                            </h3>
                        </div>
                        <!--end::Header-->
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-12">
                                        <x-cento-dash-input type="select" name="child_category_id"
                                            label="Child Category" :options="$childCategories"
                                            :message="$errors->first('child_category_id')" />
                                    </div>
                                </div>
                            </div>
                            <div class="modal-footer mt-5 gap-2">
                                <x-cento-dash-input type="submit" label="Add Sub Category" />
                                <a class="btn btn-danger" href={{ route('sub.category.index') }}> Cancel </a>
                            </div>
                            <!--end::Table container-->
                        </div>
                        <!--begin::Body-->
