                    ...
                    <div class="card mb-5 mb-xl-8" style="user-select: auto;">
                        ...
                        <div class="card-body pt-3" style="user-select: auto;">
                            ...
                            <div class="modal-body">
                                ...
                                <!--end::Label-->
                                <div class="row">
                                    <x-cento-dash-input type="text" name="name" label="Permission Name"
                                        placeholder="Permission Name" :message="$errors->first('name')" />
                                    <x-cento-dash-input type="text" name="guard_name" label="Guard Name"
                                        placeholder="Guard Name" :message="$errors->first('guard_name')" />
                                </div>
                            </div>
