            ...
            <div class="panel panel-default credit-card-box">
                ...
                <div class="panel-body">
                    ...
                    <form
                        ...
                        <div class='form-row row'>
                            <div class='col-xs-12 form-group card required'>
                                <label class='control-label'>Card Number</label> <input
                                    autocomplete='off' class='form-control card-number cc-number' size='20' maxlength="19"
                                    type='text' >
                            </div>
                        </div>
                        ...
                        <div class='form-row row'>
                            <div class='col-xs-12 col-md-4 form-group cvc required'>
                                <label class='control-label'>CVC</label> <input autocomplete='off'
                                    class='form-control card-cvc cc-cvc' placeholder='ex. 311' size='4'
                                    type='text'>
                            </div>
                        ...
                        <div class="row">
                            <div class="col-xs-12">
                            <button class="btn btn-primary btn-lg btn-block" type="submit">Pay Now ({{$ids->totalprice}}$)</button>
                            </div>
                        </div>
