...
<div id="kt_app_sidebar" class="app-sidebar flex-column" data-kt-drawer="true" data-kt-drawer-name="app-sidebar"
    ...
    <div class="app-sidebar-logo px-6" id="kt_app_sidebar_logo">
        ...
        <a href="{{route('admin.dashboard')}}">
            <img alt="Logo" src="assets/media/logos/logo1.png" width="150px" height="150px" class=" app-sidebar-logo-default" />
            <img alt="Logo" src="assets/media/logos/logo.png" width="80px" style="margin-left: -24px;" height="80px" class=" app-sidebar-logo-minimize" />
        </a>
        <!--end::Logo image-->
        ...
        <div id="kt_app_sidebar_menu_wrapper" class="app-sidebar-wrapper hover-scroll-overlay-y my-5"
            ...
            <div class="menu menu-column menu-rounded menu-sub-indention px-3" id="#kt_app_sidebar_menu"
                ...
                <div data-kt-menu-trigger="click"
                    class="menu-item menu-accordion {{Request::route()->getName()=='user.edit'?'hover show':''}}{{Request::route()->getName()=='user.create'?'hover show':''}}{{Request::route()->getName()=='user.index'?'hover show':''}}">
                    <!--begin:Menu link-->
                            ...
                            <span class="svg-icon svg-icon-2">
                                <!--begin::Svg Icon--><svg xmlns="http://www.w3.org/2000/svg"
                                    ...
                                    <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                                        ...
                                        <rect fill="currentColor" opacity="0.3" x="2" y="4" width="5" height="16"
                                            rx="1">
                                        </rect>
                                    </g>
                                </svg>
                    ...
                    <div class="menu-sub menu-sub-accordion">
                        ...
                        <div class="menu-item">
                            <!--begin:Menu link-->
                            <a class="menu-link  {{Request::route()->getName()=='user.edit'?'active':''}}{{Request::route()->getName()=='user.create'?'active':''}}{{Request::route()->getName()=='user.index'?'active':''}}"
                ...
                <!--begin:Menu item-->
                <div data-kt-menu-trigger="click"
                    class="menu-item menu-accordion {{Request::route()->getName()=='role.edit'?'hover show':''}}{{Request::route()->getName()=='role.create'?'hover show':''}}{{Request::route()->getName()=='role.index'?'hover show':''}}">
                    <!--begin:Menu link-->
                    <span class="menu-link">
                        <span class="menu-bullet">
                            <span class="svg-icon svg-icon-2">
                    ...
                    <div class="menu-sub menu-sub-accordion">
                        ...
                        <div class="menu-item">
                            <!--begin:Menu link-->
                            <a class="menu-link {{Request::route()->getName()=='role.edit'?'active':''}}{{Request::route()->getName()=='role.create'?'active':''}}{{Request::route()->getName()=='role.index'?'active':''}}"
                ...
                <div class="menu-item menu-accordion">
                    <!--begin:Menu link-->
                    <a class="menu-link {{Request::route()->getName()=='permission.edit'?'active':''}}{{Request::route()->getName()=='permission.create'?'active':''}}{{Request::route()->getName()=='permission.index'?'active':''}}"
                ...
                {{Request::route()->getName()=='sub.category.edit'?'hover show':''}}">
                    ...
                    <div class="menu-sub menu-sub-accordion">
                        ...
                        <div class="menu-item">
                            <!--begin:Menu link-->
                            <a class="menu-link {{Request::route()->getName()=='sub.category.index'?'active':''}}{{Request::route()->getName()=='sub.category.create'?'active':''}}{{Request::route()->getName()=='sub.category.edit'?'active':''}}"
                ...
                <div class="menu-item menu-accordion ">
                    <!--begin:Menu link-->
                    <a class="menu-link {{Request::route()->getName()=='brand.edit'?'active':''}}{{Request::route()->getName()=='brand.create'?'active':''}}{{Request::route()->getName()=='brand.index'?'active':''}}"
                ...
                <div class="menu-item menu-accordion ">
                    <!--begin:Menu link-->
                    <a class="menu-link {{Request::route()->getName()=='blog.edit'?'active':''}}{{Request::route()->getName()=='blog.create'?'active':''}}{{Request::route()->getName()=='blog.index'?'active':''}}"
                ...
                <div data-kt-menu-trigger="click" class="menu-item menu-accordion mb-1">
                    ...
                    <div class="menu-sub menu-sub-accordion">
                        ...
                        <div class="menu-item">
                            ...
                            <a class="menu-link  {{Request::route()->getName()=='order.detail'?'active':''}}{{Request::route()->getName()=='order.edit'?'active':''}}"   href="{{ route('order.detail') }}">
                                            <span class="menu-bullet">
                                                <span class="bullet bullet-dot"></span>
                                            </span>
                        ...
                        <div class="menu-item">
                            <!--begin:Menu link-->
                            <a class="menu-link  {{Request::route()->getName()=='order.trans'?'active':''}}" href="{{ route('order.trans') }}">
                                            <span class="menu-bullet">
                                                <span class="bullet bullet-dot"></span>
                                            </span>
                ...
                <div class="menu-item pt-5">
                    <!--begin:Menu content-->
                    <div class="menu-content">
                        <span class="menu-heading fw-bold text-uppercase fs-7">User Settings</span>
                    </div>
                    <!--end:Menu content-->
                </div>
                <!--end:Menu item-->
