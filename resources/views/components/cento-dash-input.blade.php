...
<div class="mb-10 my-4">
    ...
    <select class="form-select form-select-solid is-valid" name="{{ $name }}" data-placeholder="Select an option"
        data-allow-clear="true" data-control="select2" @if ($type==='multi-select' ) multiple="multiple" @endif>
