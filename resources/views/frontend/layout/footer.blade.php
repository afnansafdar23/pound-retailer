<!-- Footer Top Area
============================================ -->
<div class="footer-top-area pb-30 pt-50">
    <div class="container">
        <div class="row">
            <div class="footer-contact col-lg-4 col-md-6 col-12">
                <img src="img/logo-2.webp" alt="">
                <div><span>Address :</span>
                    <p>28 Green Tower, Street Name, <br>New York City, USA</p>
                </div>
                <div><span>Cell-Phone :</span>
                    <p>+8880 44338899</p>
                </div>
            ...
            <div class="footer-newsletter col-lg-4 col-md-6 col-12">
