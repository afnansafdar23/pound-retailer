...
<body>
    ...
    <div class=" p-0">
        <div class=" d-flex justify-content-space-center bg-danger"
            style="height: 150px; position:sticky; top:0; z-index:100; width:100%;">
            <div class="col-md-4"></div>
            <div class="col-md-1"></div>
            <img id="logoimg" class="col-md-2" src="{{asset('assets/front end/image1-2.jpg')}}" width="200px"
                height="100px">
