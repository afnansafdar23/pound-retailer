...
@section('content')
    ...
    <div class="gallery mt-2">
        ...
        <div class="img-container">
            <img class="grid-img" src="{{ asset('assets/front end/home-image/13 (2).png') }}"
            ...
            <div>
                <div class="owl-carousel owl-theam owl-carousel2">
                    <div class="card" style="width: 18rem;">
                        <img src="https://bestjquery.com/tutorial/product-grid/demo57/images/img-6.jpg"
    ...
    <section class="container-fluid row  mb-2 rounded-3  p-1 ">
        <div class="col-md-6 aboutimg col-sm-12 p-4"><img class="col-12"
                src="{{ asset('assets/front end/image1-2.jpg') }}" alt="" width="400px" height="400px"> </div>
        <div class="col-md-4 col-sm-12 overflow-hidden" style="margin-left: 15px;"> <span class="fs-1 pt-4 col-12">About
                us</span>
            <p class="text-dark fs-5 col-12">Lorem ipsum dolor, sit amet consectetur adipisicing elit. Incidunt, neque
                dolorum dicta iste quam ex numquam, illo unde fugit recusandae odio illum eaque. Lorem ipsum dolor, sit amet
                consectetur adipisicing elit. Fuga ipsum eos cupiditate aliquam facilis, excepturi, quos commodi eligendi
                provident, molestias error labore sapiente?</p>
        </div>
    ...
    <section class="row container-fluid  ">
        ...
        <br>
        <div class="col-md-3 ">
            <img class="col-12" src="{{ asset('assets/front end/image1-2.jpg') }}" alt="" width="auto"
                height="auto">
            <span class="fs-2">this is first blog</span>
            <p class="text-dark fs-4 wrap overflow-hidden wrap">Lorem, ipsum dolor sit amet consectetur adipisicing elit.
                Earum unde fugiat consequatur laborum optio eveniet illo, sed repudiandae eius eum illum eos iure doloribus
                corporis nostrum voluptas accusamus libero perspiciatis!</p>
        ...
        <div class="col-md-3 ">
            ...
            <p class="text-dark fs-4 wrap overflow-hidden">Lorem, ipsum dolor sit amet consectetur adipisicing elit. Earum
                unde fugiat consequatur laborum optio eveniet illo, sed repudiandae eius eum illum eos iure doloribus
                corporis nostrum voluptas accusamus libero perspiciatis!</p>
